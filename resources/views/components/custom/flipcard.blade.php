<div>
    <!-- Desktop Version -->
    <div class="hidden lg:block group relative h-96 w-72 [perspective:1000px] cursor-pointer">
        <div
            ...
            <div class="absolute w-full h-full rounded-xl p-6 text-white [backface-visibility:hidden] overflow-hidden"
                ...
                <div class="flex flex-col h-full relative z-10">
                    ...
                    <div class="mt-auto flex items-center space-x-2">
                        ...
                        <p class="text-sm font-medium tracking-wide opacity-75">HOVER TO REVEAL</p>
                    </div>
                </div>
            </div>
            ...
            <div class="absolute w-full h-full rounded-xl p-6 text-white [transform:rotateY(180deg)] [backface-visibility:hidden] overflow-hidden"
                ...
                <div class="absolute top-0 left-0 w-full h-32 bg-white opacity-5 -rotate-45 transform -translate-y-16">
                </div>
                ...
                <div class="flex flex-col h-full relative z-10">
                    ...
                    <div class="flex justify-between items-center mt-auto">
                        <a href="{{ route($actionRoute) }}"
                            class="px-4 py-2 bg-white text-red-700 rounded-lg font-semibold hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 hover:shadow-glow">
                            {{ $actionText }}
                        </a>
    ...
    <div class="block lg:hidden relative w-full h-48 rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col justify-between items-center h-full text-white p-6">
            ...
            <a href="{{ route($actionRoute) }}"
                class="px-5 py-2 bg-white text-red-600 rounded-lg font-semibold hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 shadow-md">
                {{ $actionText }}
            </a>
        </div>
    </div>
