<article x-data="{ hovered: false }" 
    ...
    class="relative lg:w-96 min-w-48 w-48 overflow-hidden rounded-2xl px-4 sm:px-8 pb-8 pt-40 mt-4 transition-transform transform hover:-translate-y-4 duration-400">
