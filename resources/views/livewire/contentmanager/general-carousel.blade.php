    ...
    slides: [                
        {
            ...
            goto: '{{route('welcome')}}',
            goto_text: 'Cek Postingan 2',
            title: 'Misal Proker',
            description: 'Misal ini Proker 1',           
        },                
        {                    
            imgSrc: 'https://penguinui.s3.amazonaws.com/component-assets/carousel/default-slide-2.webp',                    
            imgAlt: 'Vibrant abstract painting with swirling red, yellow, and pink hues on a canvas.',
            goto: '{{route('welcome')}}',
            goto_text: 'Cek Postingan 3',
            title: 'Misal Kegiatan',
            description: 'Proker ato kegiatan kunjungan sing arep disogna banner',            
        },                
        {                    
            imgSrc: 'https://penguinui.s3.amazonaws.com/component-assets/carousel/default-slide-3.webp',                    
            imgAlt: 'Vibrant abstract painting with swirling blue and purple hues on a canvas.',
            goto: '{{route('welcome')}}',
            goto_text: 'See Our Services',
            title: 'Cek Postingan 4',
            description: 'Proker ato kegiatan kunjungan sing arep disogna banner',       
        },            
    ],            
    currentSlideIndex: 1,
