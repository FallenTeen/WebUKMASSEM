        ...
        <div
                ...
                <div class="flex flex-col justify-center items-center text-center">
                    ...
                    <div class="flex items-center justify-center">
                        <div class="px-16 py-2 relative overflow-hidden group">
                            <div
                                class="absolute -left-10 top-0 bottom-0 w-24 bg-green-600 group-hover:w-[calc(100%+3rem)] transition-all duration-300 ease-in-out">
                            </div>
                            <p
            ...
            <div class="w-1/2 items-center justify-center text-center flex h-1/2">
                <a href="#deskripsi"
                    ...
                    Jelajahi Tentang Divisi Fotografi
